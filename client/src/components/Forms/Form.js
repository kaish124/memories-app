...
const Form = ({ currentId, setCurrentId }) => {
    ...
    useEffect(() => {
      if(currentId == null)setPostData({ creator: '', title: '', message: '', tags: '', selectedFile: ''});    //edited.......
    }, [currentId])
    ...
    const handleSubmit = (e) => {
        ...
        //  console.log(postData.createdAt);
         if(currentId){
          ...
          // setPostData({...postData, createdAt: date});
    ...
    return(
        <Paper className={classes.paper}>
           <form autoComplete="off" noValidate className={`${classes.form} ${classes.root}`} onSubmit={handleSubmit}>
             ...
             <TextField required name="creater" variant="outlined" label="Creator" fullWidth value={postData.creator} onChange={(e) => setPostData({ ...postData, creator: e.target.value})}/>
